...
-- 5.Display all the orders along with product name 
...
-- 9.Display customer name and gender whose names start or end with the character 'A'.
...
-- 10.Create a stored procedure to display supplier id, name, Rating (Average rating of all the products 
